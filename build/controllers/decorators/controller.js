...
function controller(routePrefix) {
    return function (target) {
        ...
        for (var key in target.prototype) {
            ...
            var path = Reflect.getMetadata(types_1.MetadataKeys.path, target.prototype, key);
            var method = Reflect.getMetadata(types_1.MetadataKeys.method, target.prototype, key);
            var middlewares = Reflect.getMetadata(types_1.MetadataKeys.middleware, target.prototype, key) ||
                [];
            var requiredBodyProps = Reflect.getMetadata(types_1.MetadataKeys.validator, target.prototype, key) ||
                [];
